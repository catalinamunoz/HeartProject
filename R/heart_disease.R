...
#' \describe{
#'    \item{HeartDisease}{Has the respondent had coronary heart disease or myocardial infarction?}
#'    \item{BMI}{Body Mass Index}
#'    \item{Smoking}{ Have they smoked 100 cigarettes in their lifetime? }
#'    \item{AlcoholDrinking}{Are they a heavy drinker? Men: More then 14 drinks per week, Women: More than 7}
#'    \item{Stroke}{Have they had a stroke in their lifetime?}
...
#'    \item{DiffWalking}{Is it difficult to walk or climb the stairs?}
#'    \item{Sex}{Male or Female}
#'    \item{AgeCategory}{13 level age category ranging from 18 to 80 years or older}
#'    \item{Race}{Race/Ethnicity}
#'    \item{Diabetic}{Have they had diabetes?}
#'    \item{PhysicalActivity}{Have they reported exercise in the past 30 days?}
#'    \item{GenHealth}{In general, how good do they think their health is?}
#'    \item{SleepTime}{How many hours of sleep do they get per day?}
#'    \item{Asthma}{Have they had asthma?}
#'    \item{KidneyDisease}{Have they had kidney disease?}
#'    \item{SkinCancer}{Have they had skin cancer?}
#' }
